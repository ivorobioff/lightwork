...
class LogsBuilder
{
	...
	/**
	 * @return \LightWork\Models\LogsBuilder\Iterator
	 */
	public function createLogsIterator()
	{
		return new LogsIterator($this->_getData());
	}

	/**
	 * @return \LightWork\Libs\Paginator
	 */
	public function getPaginator()
	{
		if (is_null($this->_cache_paginator))
		{
			$this->_cache_paginator = new Paginator($this->_getTotal(), $this->_page);
